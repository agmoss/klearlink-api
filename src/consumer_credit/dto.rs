    ...
    fn from(consumer_credit: ConsumerCreditModel) -> Self {
        ConsumerCreditDto {
            ...
            credit_facts: CreditFactsDto {
                ...
                originated_datetime: consumer_credit.originated_datetime.filter(|_| consumer_credit.originated_datetime.is_some()),
                payment_due_date: consumer_credit.payment_due_date.filter(|_| consumer_credit.payment_due_date.is_some()),
                payment_due_amount: consumer_credit.payment_due_amount.filter(|_| consumer_credit.payment_due_amount.is_some()),
