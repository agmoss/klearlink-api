...
pub async fn submit_consumer_credit<'r>(
    ...
    Service::submit_consumer_credit(consumer_credit_id_dto, record, auth, conn).await
}
...
pub async fn update_consumer_credit<'r>(
    ...
    Service::update_consumer_credit(consumer_credit_id_dto, record, auth, conn).await
}
...
pub async fn view_consumer_credit(
    ...
    Service::view_consumer_credit(consumer_credit_id_dto, auth, conn).await
}
...
pub async fn view_consumer_match(
    ...
    Service::view_consumer_match(consumer_credit_id_dto, auth, conn).await
}
